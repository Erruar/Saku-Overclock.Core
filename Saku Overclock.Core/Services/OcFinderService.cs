...
public class OcFinderService : IOcFinderService
{
    ...
    public OcFinderService(IDataProvider dataProvider, ICpuService cpu)
    {
    ...
    public void LazyInitTdp()
    {
        ...
        _isPlatformPc = _cpu.IsPlatformPc() == true;
        ...
        var codenameGeneration = _cpu.GetCodenameGeneration();
    ...
    private bool CheckUndervoltingFeature()
    {
        ...
        _isUndervoltingAvailable = _cpu.ReturnUndervoltingAvailability();
